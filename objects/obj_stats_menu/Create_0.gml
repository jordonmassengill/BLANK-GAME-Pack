...
ds_map_add(upgrade_colors, "life", make_color_rgb(255, 50, 50));
ds_map_add(upgrade_colors, "power", make_color_rgb(50, 50, 255));
ds_map_add(upgrade_colors, "manifest", make_color_rgb(255, 165, 0));
ds_map_add(upgrade_colors, "speed", make_color_rgb(50, 255, 50));
ds_map_add(upgrade_colors, "defense", make_color_rgb(200, 50, 255));
ds_map_add(upgrade_colors, "finesse", make_color_rgb(139, 69, 19));

// Stats to display from stats system (This is unchanged)
stats_list = [
